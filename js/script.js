...
var countDownDate = new Date("Oct 08, 2022 15:30:00").getTime();
...
//   };
  ...
  function add_task(){
    ...
    if(input_box.value.length != 0 && input_date.value.length != 0){
      ...
      var key = firebase.database().ref().child("frida").push().key;
      var task = {
...
function create_unfinished_task(){
    ...
    task_array = [];
    firebase.database().ref("frida").once('value', function(snapshot) {
